 ...
 */
public class JCustomMapFrame extends JFrame {
    ...
    public static void showMap(MapContext context) {
        final JCustomMapFrame frame = new JCustomMapFrame(context);
...
//        frame.initComponents();
     ...
     */
    public JCustomMapFrame(MapContext context) {
     ...
     */
    public JCustomMapFrame(MapContext context, GTRenderer renderer) {
     ...
     * calling {@linkplain #enableTool} with all {@linkplain JCustomMapFrame.Tool}
     * constants.
     *
     ...
     * by {@linkplain JCustomMapFrame.Tool} constants.
     * <code><pre>
     * myMapFrame.enableTool(Tool.PAN, Tool.ZOOM);
     * </pre></code>
     *
     * @param tool one or more {@linkplain JCustomMapFrame.Tool} constants
     */
