...
public class MySQLConnector implements Connector{
	...
	private static final String DEF_USER = "muser";
	private static final String DEF_PASS = "mpass";
	private static final String DEF_HOST = "127.0.0.1";//? wherever we end up putting the real server
	private static final String DEF_PORT = "1000";
	...
	*/
	...
	public MySQLConnector(){
		this(ConnectionDefinitions.MYSQL);
	}
	public MySQLConnector(ConnectionDefinitions cd){
